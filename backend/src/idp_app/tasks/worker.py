...
def send_welcome_email(self: Celery, user_id: int, email: str) -> dict[str, str]:  # type: ignore[type-arg]
...
def cleanup_expired_tokens(self: Celery) -> dict[str, int]:  # type: ignore[type-arg]
